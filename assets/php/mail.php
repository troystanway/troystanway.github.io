<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // access
        $secretKey = '6LdU5HMUAAAAALR33eXlZSEN5wNvYc0m97rJUEUI';
        ...
        $mail_to = 'troy@troystanway.com.au';
        ...
        if(intval($responseKeys["success"]) !== 1) {
          echo '<p class="alert alert-warning">Please check the the captcha form.</p>';
            ...
            # email headers.
            $headers = 'From: Website Form <markstanway1@s321.syd1.hostingplatform.net.au>' . "\r\n";
